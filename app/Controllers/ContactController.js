...
export default class ContactController extends Controller {
    constructor() {
        ...
        this.SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzn3f-2C-RE281BQdGJRaP17PBtdhEVR5M-wV3s94TRozLl9GANMk5_IMn6U_ASBdES-Q/exec'; 
    }
    ...
    async submitAspiration(e) {
        ...
        const data = {
            nama: document.getElementById('asp-nama').value,
            rt: document.getElementById('asp-rt').value,
            kategori: document.getElementById('asp-kategori').value,
            pesan: document.getElementById('asp-pesan').value
        };
